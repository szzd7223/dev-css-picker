            ...
            <div className="h-full flex flex-col p-4 animate-fade-in">
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center pb-20">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-sm font-bold shadow-lg shadow-blue-900/20 transition-all flex items-center gap-2"
                    >
